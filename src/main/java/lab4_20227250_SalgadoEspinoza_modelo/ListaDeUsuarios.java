...
/**
 * Una clase para representar la lista de usuarios que contendr� el stack.
...
public class ListaDeUsuarios {
    ...
    */
    ...
    /**
    * Metodo que consulta si un usuario se encuentra ya en la lista.
    ...
    * @param myUsuario que se va a comparar con el resto de los usuarios, se compara solo el nombre y la clave para ver si est�n correctas.
    * @return Boolean true si se encuentra dentro, false si no se encuentra
    */
    ...
    */
    ...
    //Esta vacia la lista de usuarios.
